...
import com.example.wxchatdemo.kotlin.fragment.ContactListFragment;
import com.example.wxchatdemo.kotlin.fragment.FindFragment;
import com.example.wxchatdemo.kotlin.fragment.SelfFragment;
import com.example.wxchatdemo.kotlin.fragment.WeixinFragment;
...
public class MainWeixin extends FragmentActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 初始化布局元素
        initViews();
        fragmentManager = getSupportFragmentManager();//用于对Fragment进行管理
        // 设置默认的显示界面
        setTabSelection(0);
    }
